...
const el = {
  ...
  rotationTip: document.querySelector("#rotation-tip"),
  rotationTipDismiss: document.querySelector("#rotation-tip-dismiss"),
  ...
  hubMapBetaStart: document.querySelector("#hub-map-beta-start"),
  hubMapBetaBack: document.querySelector("#hub-map-beta-back"),
  hubMapBetaCanvas: document.querySelector("#hub-map-beta-canvas"),
  hubMapBetaCoords: document.querySelector("#hub-map-beta-coords"),
  ...
  lastGearSetupAi: document.querySelector("#last-gear-setup-ai"),
  lastGearSetupStart: document.querySelector("#last-gear-setup-start"),
  lastGearBeta: document.querySelector("#last-gear-beta"),
  lastGearBetaBack: document.querySelector("#last-gear-beta-back"),
  lastGearCanvas: document.querySelector("#last-gear-canvas"),
  lastGearSpeed: document.querySelector("#last-gear-speed"),
  lastGearNitroFill: document.querySelector("#last-gear-nitro-fill"),
  lastGearStatusGrid: document.querySelector("#last-gear-status-grid"),
  lastGearItemSlot: document.querySelector("#last-gear-item-slot"),
  lastGearItemIcon: document.querySelector("#last-gear-item-icon"),
  lastGearItemName: document.querySelector("#last-gear-item-name"),
  lastGearAnnouncer: document.querySelector("#last-gear-announcer"),
  lastGearAnnouncerEvent: document.querySelector("#last-gear-announcer-event"),
  lastGearAnnouncerLine: document.querySelector("#last-gear-announcer-line"),
  lastGearResults: document.querySelector("#last-gear-results"),
  lastGearResultTitle: document.querySelector("#last-gear-result-title"),
  lastGearResultCopy: document.querySelector("#last-gear-result-copy"),
  lastGearRestart: document.querySelector("#last-gear-restart"),
  lastGearFinishExit: document.querySelector("#last-gear-finish-exit"),
  ...
  storyFactionBadge: document.querySelector("#story-faction-badge"),
  storyFactionBadgeImg: document.querySelector("#story-faction-badge-img"),
  ...
  honkModal: document.querySelector("#honk-modal"),
  honkModalClose: document.querySelector("#honk-modal-close"),
  honkOptions: document.querySelector("#honk-options"),
  honkSubtitle: document.querySelector("#honk-subtitle"),
  ...
  forgeCardTitle: document.querySelector("#forge-card-title"),
  forgeCardSubtitle: document.querySelector("#forge-card-subtitle"),
  forgeKicker: document.querySelector("#forge-kicker"),
  forgeTitle: document.querySelector("#forge-title"),
  forgeSubtitle: document.querySelector("#forge-subtitle"),
